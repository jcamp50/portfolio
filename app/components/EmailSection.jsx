...
const EmailSection = () => {
  ...
  return (
    <section
      ...
      id='contact'
    >
      <div className='bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[#047857] to-transparent rounded-full h-80 w-80 z-0 blur-lg absolute top-3/4 -left-4 transform -translate-x-1/2 -translate-1/2'></div>
      <div className='z-10'>
        <h2 className='text-4xl font-bold text-white my-2'>
          Let&apos;s Connect
        </h2>
        <p className='font-mono text-[#ADB7BE] mb-4 max-w-md'>
          {' '}
