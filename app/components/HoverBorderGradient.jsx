...
export function HoverBorderGradient({
  ...
  const highlight =
    'radial-gradient(75% 181.15942028985506% at 50% 50%, #3cce6d 0%, rgba(255, 255, 255, 0) 100%)';
  ...
  return (
    ...
    >
      <div
        className={`w-auto text-white z-10 px-4 py-2 rounded-[inherit] ${className}`}
      >
        {children}
      </div>
      <motion.div
      ...
      />
      <div className='bg-[#353535] absolute z-1 flex-none inset-[2px] rounded-[100px]' />
    </Tag>
  );
}
